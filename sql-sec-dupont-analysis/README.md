...
**Data Source:** [SEC Financial Statement Data Sets](https://www.sec.gov/data-research/sec-markets-data/financial-statement-data-sets) — quarterly flat-file datasets published by the U.S. Securities and Exchange Commission, containing structured financial statement data submitted by public filers.
